...
<body>
 ...
 $pid=+19;
$query=("SELECT  productid,pname,pimage,categoryid,pprice,pricesale,pdescription,pquantity,pname FROM products where categoryid='1' AND productid=19");
...
$query=("SELECT  pname,pimage,categoryid,pprice,pricesale,pdescription,pquantity,pname FROM products where categoryid='1' AND productid=20");
$result=mysqli_query($conn,$query) or die('couldnt querry'.mysqli_error($conn));
while ($row=mysqli_fetch_array ($result)){
  $pname=$row['pname'];
  $image=$row['pimage'];
...
?> 
    ...
    // mysql_select_db('default');
            ...
            $query=("SELECT  productid,pname,pimage,categoryid,pprice,pricesale,pdescription,pquantity,pname FROM products where categoryid='1' AND productid=21");
            $result=mysqli_query($conn,$query) or die('couldnt querry'.mysqli_error($conn));
            while ($row=mysqli_fetch_array ($result)){
              $pname=$row['pname'];
              $image=$row['pimage'];
...
?> 
          ...
          <section class="pone" id="full">
            ...
            <h3><?php echo $pname; ?> (<?php echo $pquantity ?>) <ins> ksh <?php echo $pricesale; ?></ins><br> <del>Ksh <?php echo $pprice; ?></del></h3>
            <!-- <h3>TecnoJ8 8 &nbsp  <ins> ksh : 30000.00</ins><br> <del>30000.00</del></h3> -->
            <button type="button" class="btn btn-secondary"><a href="login.php">Buy Now</a></button>
            
          </section>
          <section class="pone" id="full">
            <div class="image">
              <img src="images/phones/tec2.jpg">
            </div>
            <h3><?php echo $pname; ?> (<?php echo $pquantity ?>) <ins> ksh <?php echo $pricesale; ?></ins><br> <del>Ksh <?php echo $pprice; ?></del></h3>
            <!-- <h3>TecnoJ8  &nbsp  <ins> ksh : 30000.00</ins><br> <del>30000.00</del></h3> -->
            <button type="button" class="btn btn-secondary"><a href="login.php">Buy Now</a></button>
